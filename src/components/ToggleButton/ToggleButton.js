...
export class ToggleButton extends Component {
    constructor(props) {
        ...
        this.$checkedPos = Math.max(
            width - this.$handleDiameter - height,
            width - this.$handleDiameter - (height + this.$handleDiameter) / 2
        );
    ...
    render() {
        const {
            ...
            height,
            width,
            backgroundStyle: backgroundStyleCustom,
            rootStyle: rootStyleCustom,
        ...
        return (
            <div className={className} style={({ ...rootStyle, ...rootStyleCustom })}>
                <div
                    className="react-switch-bg"
                    style={({ ...backgroundStyle, ...backgroundStyleCustom })}
                ...
                >{this.props.checked ? 'Søg' : 'Skan'}</div>
                <input
                    type="checkbox"
                    role="switch"
                    disabled={disabled}
